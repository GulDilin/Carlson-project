...
public class Move implements Talkable {
    ...
    public void go(){
        ...
        for(Window window: windows){
            System.out.println(window.getColor().getColorName()+"е");
        }
        System.out.println();
    ...
    public void printStatus(){
        System.out.println(this.carlson.toString() + " и " + this.baby.toString() + " y " + windows[currWindowID].getColor().getColorName()+ "го окна");
        System.out.println(targetWindowID == -1 ? "Окно - цель не выбрано" : "Малыш и карлсон ползут к " + windows[targetWindowID].getColor().getColorName() + "му окну");
